    ...
    stages {
        ...
        stage('Push Docker Image') {
		    ...
		    docker login -u rrjoshi9 -p Rahul@12345
                    ...
                    docker tag ${DOCKER_IMAGE}:latest dhruvilbhtt/php-app:latest
    ...
    steps {
        script {
            ...
            if (env.BRANCH_NAME == 'stage') {
                ...
                echo "Skipping deployment as not on the stage branch"
            }
        }
    }
}
    ...
    steps {
        script {
            ...
            if (env.BRANCH_NAME == 'prod') {
                ...
                echo "Skipping deployment as not on the prod branch"
            }
        }
    }
}
